...
import se.miun.nowandthen.data.Json;
import se.miun.nowandthen.data.KSSXMLHandler;
import se.miun.nowandthen.data.XMLHandler;
			...
			if(ctx!=null && request!=null && ctx.getHttpGETInputStream(request.url)!=null){
				...
				try {
					...
					try {
						...
						KSSXMLHandler xml = new KSSXMLHandler();
