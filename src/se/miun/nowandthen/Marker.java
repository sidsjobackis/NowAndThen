...
import se.miun.nowandthen.gui.ScreenObj;
import se.miun.nowandthen.gui.TextObj;
...
//	private MixVector oMarker = new MixVector();
	...
	public Marker(String title, double latitude, double longitude, double altitude, String description, String datasource) {
		super();
