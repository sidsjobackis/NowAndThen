...
public class MixContext extends ContextWrapper {
	...
	private HashMap<String,Boolean> selectedDataSources=new HashMap<String,Boolean>();
	...
	public MixContext(Context appCtx) {
		...
		for(String source: NameHelper.NAMES) {
...
//			setDataSource(DATASOURCE.WIKIPEDIA, true); // TODO Default datasource satt till WIKIPEDIA
	...
	public void setDataSource(String source, Boolean selection){
	...
	public Boolean isDataSourceSelected(String source) {
		return selectedDataSources.get(source);
	}
	
	public void toogleDataSource(String source) {
