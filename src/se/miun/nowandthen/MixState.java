...
import se.miun.nowandthen.render.Matrix;
import se.miun.nowandthen.render.MixVector;
...
public class MixState {
	...
	public boolean handleEvent(MixContext ctx, Marker onPress) { // TODO onClick handler
...
//			}
//		} 
		Intent showInfo = new Intent(ctx, ObjectInfo.class);
		showInfo.putExtra("title", onPress.title);
		showInfo.putExtra("location", onPress.getLatitude()+ " " + onPress.getLongitude());
		showInfo.putExtra("description", onPress.description);
		
		ctx.startActivity(showInfo);
